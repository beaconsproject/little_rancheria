...
for (sea in seasons) {
  ...
  crf
  png(paste0('../output/random_forests/',sea,'_varimp.png'))
  varImpPlot(crf)
  dev.off()
  varImpPlot(crf)
  ...
  print(rrf)
  png(paste0('../output/random_forests/',sea,'_rrf.png'))
  plot(rrf)
  dev.off()
  plot(rrf)
  ...
  png(paste0('../output/random_forests/',sea,'_map.png'))
  plot(rp)
  dev.off()
  plot(rp)
  writeRaster(p1, paste0("../output/random_forests/",sea,"map.tif"), overwrite=TRUE)

  # Evaluate model
  eva <- pa_evaluate(predict(rrf, test[test$pa==1, ]), predict(rrf, test[test$pa==0, ]))
  png(paste0('../output/random_forests/',sea,'_auc.png'))
  plot(eva, "ROC")
  dev.off()
  plot(eva, "ROC")
  print(eva)
